...
var html="";
for (var i = 0; i < 18; i++) {
	html+='<li><div class="gbb_laji"><a href="goodsDetails.html"><img src="../images/lajitong.gif" alt=""></a></div><p class="gang_left">钢铁垃圾桶</p></li>'
}
var ent=document.querySelector("#ljliebiao");
ent.innerHTML=html;

var rubbish = document.getElementById("ljliebiao");
 var rubLi = rubbish.getElementsByTagName("li");
 for(var i=0; i<rubLi.length; i++){
 	if(3*i+1<rubLi.length && 3*i+1>0){
 		rubLi[3*i+1].style.margin = "0 20px";
 	}
 }